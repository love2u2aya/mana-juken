...
const schools = [
  ...
  },
  {
    ...
    prefecture: "東京都", region: "関東",
    hensachi: 68, hasAO: false, hasRecommendation: true,
  ...
  },
  {
    ...
    hensachi: 60, hasAO: true, hasRecommendation: true,
  ...
  },
  {
    ...
    hensachi: 58, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "農・生命", "医・薬・歯・看護", "教育"]
  },
  {
    id: 15, name: "岡山大学", type: "国公立",
    prefecture: "岡山県", region: "中国・四国",
    hensachi: 57, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "農・生命", "医・薬・歯・看護", "教育"]
  },
  {
  ...
  // ========== 私立：早慶上智 ==========
  {
    ...
    prefecture: "東京都", region: "関東",
    hensachi: 70, hasAO: false, hasRecommendation: true,
  ...
  // ========== 私立：関関同立 ==========
  {
    ...
    prefecture: "京都府", region: "近畿",
    hensachi: 62, hasAO: false, hasRecommendation: true,
  ...
  },
  {
    ...
    prefecture: "東京都", region: "関東",
    hensachi: 60, hasAO: false, hasRecommendation: true,
  ...
  },
  {
    ...
    prefecture: "大阪府", region: "近畿",
    hensachi: 53, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "農・生命", "医・薬・歯・看護", "情報"]
  },
  {
    id: 35, name: "日本大学", type: "私立",
    prefecture: "東京都", region: "関東",
    hensachi: 50, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "農・生命", "医・薬・歯・看護", "芸術・デザイン"]
  },
  {
    id: 36, name: "東洋大学", type: "私立",
    prefecture: "東京都", region: "関東",
    hensachi: 55, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "社会・国際", "情報"]
  },
  {
    id: 37, name: "専修大学", type: "私立",
    prefecture: "東京都", region: "関東",
    hensachi: 52, hasAO: true, hasRecommendation: true,
  ...
  },
  {
    ...
    prefecture: "東京都", region: "関東",
    hensachi: 57, hasAO: false, hasRecommendation: true,
  ...
  },
  {
    ...
    prefecture: "福岡県", region: "九州・沖縄",
    hensachi: 48, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "医・薬・歯・看護"]
  },
  {
    id: 48, name: "東北学院大学", type: "私立",
    prefecture: "宮城県", region: "東北",
    hensachi: 47, hasAO: true, hasRecommendation: true,
    categories: ["法・政治", "経済・経営・商", "文・語学・人文", "理・工", "情報"]
  },
  {
